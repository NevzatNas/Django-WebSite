...
class UserProfile(models.Model):
    ...
    image= models.ImageField(blank=True,max_length=20, upload_to='users/')
...
class UserProfileForm(ModelForm):
    class Meta:
        model = UserProfile
        fields = ['phone', 'adress', 'city','country']
...
class Blog(models.Model):
    ...
    image= models.ImageField(blank=True,max_length=20, upload_to='images/')
    create_at = models.DateTimeField(auto_now_add=True)
    update_at = models.DateTimeField(auto_now=True)
